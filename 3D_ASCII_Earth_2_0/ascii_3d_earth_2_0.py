...
with open('C:/Users\DELL/vscodeproject/pygamenhuconcac/3D_ASCII_Earth_2_0/earth_2_0_W140_H35.txt', 'r') as file:
...
with open('C:/Users/DELL/vscodeproject/pygamenhuconcac/3D_ASCII_Earth_2_0/moon_W50_H16.txt', 'r') as file:
    data = [file.read().replace('\n', '')]
