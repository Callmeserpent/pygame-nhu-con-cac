...
# Random cornerpoint selection
    main(0, 600, 600, 3, 0.5)
    main(0, 600, 600, 4, 0.5)
    main(0, 600, 600, 5, 0.5)
    main(0, 600, 600, 5, 0.62)
    main(0, 600, 600, 6, 0.5)

# Cornerpoints cannot be chosen twice in a row
    main(1, 600, 600, 4, 0.5)
    main(1, 600, 600, 5, 0.5)
    main(1, 600, 600, 6, 0.5)

# If a cornerpoint is chosen twice, the next selected point must not be a direct neighbor.
    main(2, 600, 600, 4, 0.5)
    main(2, 600, 600, 5, 0.5)
    main(2, 600, 600, 6, 0.5)